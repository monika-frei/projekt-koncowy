        ...
        return (<>
            <div className = {`header--wrapper ${this.props.classInvisible}`}>
                <div className='header'>
                    <div className="logo"><p className= "link--logo" to="/" data-letters= "Adventure" onClick = {this.props.handleMainContent}><Link to='/' style= {{textDecoration: 'none', color: '#28251F'}}>Adventure</Link></p></div>
